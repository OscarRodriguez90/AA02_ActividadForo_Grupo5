...
<form method="post" action="register.php" id="formRegistro">
    ...
    <div id="error-username" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "usuario")) echo $e; ?>
    </div>

    <input type="text" id="nombre" name="nombre" placeholder="Nombre"
           value="<?= isset($nombre) ? htmlspecialchars($nombre) : '' ?>">
    <div id="error-nombre" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "Nombre") || str_contains($e, "nombre") && !str_contains($e, "usuario")) echo $e; ?>
    </div>

    <input type="text" id="apellidos" name="apellidos" placeholder="Apellidos"
           value="<?= isset($apellidos) ? htmlspecialchars($apellidos) : '' ?>">
    <div id="error-apellidos" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "apellido")) echo $e; ?>
    </div>

    <input type="email" id="email" name="email" placeholder="Correo electrónico"
           value="<?= isset($email) ? htmlspecialchars($email) : '' ?>">
    <div id="error-email" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "correo")) echo $e; ?>
    </div>

    <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
           value="<?= isset($fecha_nacimiento) ? htmlspecialchars($fecha_nacimiento) : '' ?>">
    <div id="error-fecha_nacimiento" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "fecha")) echo $e; ?>
    </div>
    ...
    <div id="error-genero" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "género")) echo $e; ?>
    </div>

    <input type="password" id="password" name="password" placeholder="Contraseña">
    <div id="error-password" class="mensaje-error">
        <?php foreach ($errores as $e)
            if (str_contains($e, "contraseña") && !str_contains($e, "coinciden")) echo $e;
        ?>
    </div>

    <input type="password" id="confirmar_password" name="confirmar_password" placeholder="Confirmar contraseña">
    <div id="error-confirmar_password" class="mensaje-error">
        <?php foreach ($errores as $e) if (str_contains($e, "coinciden")) echo $e; ?>
    </div>
